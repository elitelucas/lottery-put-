...
const MyPage = (props) => {
  ...
  const [nickname, setNickname] = useState({isOpen:false,name:JSON.parse(localStorage.getItem('auth')).user.nickname});
  ...
  return (
    ...
    >
      <Row>
      <Col xl={12} lg={12} md={12} style={{backgroundColor:'#774FaF',color:'white'}}>
        <div className="mt-2" >
      ...
      <Row>       
        ...
        <Link className={'form-control'}  color="link" to="/my/promotion"  ><FaShoppingBasket className='mr-3' /> Promotion</Link>

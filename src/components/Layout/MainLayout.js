...
class MainLayout extends React.Component {
  ...
  notifyFunc = () => {
    ...
    if (this.token && this.token.user.admin) {
    ...
    return (
      <main className="cr-app bg-light">
        ...
        <Content fluid onClick={this.handleContentClick}>      
          ...
          <a href="https://wa.me/66941829160" className="btn btn-success whatsapp"><FaWhatsapp /> </a>
          <a href=" https://t.me/joinchat/HSZ3DdZwBtBUYIbT" className="btn btn-primary telegram"><FaTelegram /> </a>
          {children}
          <Footer />
        </Content>
